    ...
    return (
        <div className="flex justify-between items-center">
            ...
            <div>
                ...
                <div>
                    <h1 className='font-bold text-[1.4rem] md:hidden '>Creation de compte</h1>
                    <p className='font-bold text-[2rem] hidden md:block '>Connexion</p>
                    <p className="text-[#71717A]">Rentrez vos infos pour creer votre compte .</p>
                </div>
                <div className='mt-5'>
                    <h1 className='flex'>Nom</h1>
                    <div className='border-2 border-gray-400 rounded-lg h-10 flex justify-center items-center'>
                        <input className='border-1 rounded-lg w-full h-full' type="text" placeholder='abc.......' />
                    </div>
                </div>
                <div className='mt-3'>
                ...
                <div className='flex justify-between items-center mt-3'>
                    <div className='bg-[#00539C] md:bg-[#FF0808] h-2 w-[5rem] rounded-full'><h1> </h1></div>
